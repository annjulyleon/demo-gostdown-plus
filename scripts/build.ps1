...
$luafilter = [System.IO.Path]::GetFullPath($luafilter)
...
#&$exe $md -o $tempdocx --lua-filter $luafilter\linebreaks.lua --lua-filter $luafilter\metadata-processor.lua --filter pandoc-crossref --citeproc --reference-doc $template
